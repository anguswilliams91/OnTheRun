...
We re-ran our analysis with this object removed and found the results to be near identical. 
Later, when we assess how well our model fits the data, we remove this outlier from the sample.
