...
If the stellar halo is formed by some number of disrupted dwarf galaxies, then the power law index $k$ encodes their accretion times.
We are investigating how this information can be extracted from cosmological simulations, so that the tail can become a looking glass into the Milky Way's past.
