...
The black circled point in the MSTO panel highlights the outlier that is discussed in Section \ref{sec:res}.}
\label{fig:data}
\end{figure*}
...
Inspection of Figure \ref{fig:data} suggests one clear candidate: there is an MSTO star at $r\simeq10\kpc$, circled in black, with a measured line of sight velocity of $518.2\kms$, which is more than $100\kms$ larger than any other star at a comparable radius in our sample. 
...
From the image data it is clear that this object is a galaxy, and has been misclassified by the spectroscopic pipeline of SDSS: we therefore remove this object when comparing our model to the data.
