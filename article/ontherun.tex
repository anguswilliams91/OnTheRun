...
\citet{Ku16} argued that the observed ellipticity of Hercules ($\epsilon \simeq 0.7$) and its large line of sight velocity are suggestive that it has `exploded' as a consequence of its last pericenter passage. 
...
Both Bootes II and Hercules have positive line of sight velocities: they are travelling away from the Galactic centre, suggesting that they have undergone at least one pericenter passage. 
...
\caption{Posterior distributions on orbital pericenter $r_\mathrm{peri}$, apocenter $r_\mathrm{apo}$ and eccentricity $e$ for Bootes III, Triangulum II and Hercules. 
